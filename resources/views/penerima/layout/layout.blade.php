...
<body class="bg-slate-100 h-screen overflow-hidden flex">
    ...
    {{ request()->routeIs('penerima.dashboard') ? 'bg-teal-600 shadow-md shadow-teal-100 -translate-y-[1px]' : '' }}">


                <i
                    class="fa-solid fa-chart-pie transition-colors duration-200 {{ request()->routeIs('penerima.dashboard') ? 'text-white' : 'text-teal-700 group-hover:text-white' }}"></i>
                <span
                    class="nav-label text-sm font-medium
        transition-colors duration-200
        {{ request()->routeIs('penerima.dashboard') ? 'text-white' : 'text-teal-800 group-hover:text-white' }}">
                    Dashboard
                </span>
            </a>
    ...
    hover:bg-teal-600 hover:shadow-md hover:shadow-teal-100
    hover:-translate-y-[1px]
    {{ request()->routeIs('penerima.beasiswa') ? 'bg-teal-600 shadow-md shadow-teal-100 -translate-y-[1px]' : '' }}">
                <i
                    class="fa-solid fa-graduation-cap text-teal-700 group-hover:text-white {{ request()->routeIs('penerima.beasiswa') ? 'text-white' : 'text-teal-700 group-hover:text-white' }}"></i>
                <span
                    class="nav-label text-sm font-medium
        transition-colors duration-200
        {{ request()->routeIs('penerima.beasiswa') ? 'text-white' : 'text-teal-800 group-hover:text-white' }}">Beasiswa</span>
            </a>
    ...
    hover:bg-teal-600 hover:shadow-md hover:shadow-teal-100
    hover:-translate-y-[1px]
    {{ request()->routeIs('penerima.persyaratan.index') ? 'bg-teal-600 shadow-md shadow-teal-100 -translate-y-[1px]' : '' }}">
                <i
                    class="fa-solid fa-file-circle-check text-teal-700 group-hover:text-white {{ request()->routeIs('penerima.persyaratan.index') ? 'text-white' : 'text-teal-700 group-hover:text-white' }}"></i>
                <span
                    class="nav-label text-sm font-medium
        transition-colors duration-200
        {{ request()->routeIs('penerima.persyaratan.index') ? 'text-white' : 'text-teal-800 group-hover:text-white' }}">Persyaratan</span>
            </a>
    ...
    hover:bg-teal-600 hover:shadow-md hover:shadow-teal-100
    hover:-translate-y-[1px]
    {{ request()->routeIs('penerima.lamaran.index') ? 'bg-teal-600 shadow-md shadow-teal-100 -translate-y-[1px]' : '' }}">
                <i
                    class="fa-solid fa-chart-line text-teal-700 group-hover:text-white {{ request()->routeIs('penerima.lamaran.index') ? 'text-white' : 'text-teal-700 group-hover:text-white' }}"></i>
                <span
                    class="nav-label text-sm font-medium
        transition-colors duration-200
        {{ request()->routeIs('penerima.lamaran.index') ? 'text-white' : 'text-teal-800 group-hover:text-white' }}">Status
                    Lamaran</span>
            </a>
    ...
    {{-- ===== NOTIFICATION PANEL ===== --}}
    <div id="notif-panel" x-data="notifPanel()" x-on:notif-toggle.window="toggle()"
        x-on:notif-close.window="close()" :class="open ? 'translate-x-0' : 'translate-x-full'"
