...
<body class="bg-slate-100 h-screen overflow-hidden flex">
    ...
    <aside id="sidebar" class="w-60 bg-white flex flex-col h-screen flex-shrink-0 relative z-20">
        ...
        {{-- Navigation --}}
        <nav class="flex-1 overflow-y-auto no-scrollbar py-4 relative z-10">
    ...
    {{ request()->routeIs('penyalur.dashboard') ? 'bg-teal-600 shadow-md shadow-teal-100 -translate-y-[1px]' : '' }}">
                ...
                <span
                    class="nav-icon material-symbols-outlined text-[20px]
        transition-colors duration-200
        {{ request()->routeIs('penyalur.dashboard') ? 'text-white' : 'text-teal-700 group-hover:text-white' }}">
                    dashboard
                </span>
    ...
    hover:-translate-y-[1px]">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">person</span>
                <span class="nav-label text-teal-800 text-sm font-medium group-hover:text-white">Penerima</span>
            </a>
    ...
    hover:-translate-y-[1px]">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">corporate_fare</span>
                <span class="nav-label text-teal-800 text-sm font-medium group-hover:text-white">Penyalur</span>
            </a>
    ...
    hover:-translate-y-[1px]">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">school</span>
                <span class="nav-label text-teal-800 text-sm font-medium group-hover:text-white">Beasiswa</span>
            </a>
    ...
    hover:-translate-y-[1px] ">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">verified_user</span>
                <span
                    class="nav-label text-teal-800 text-sm font-medium flex-1 group-hover:text-white">Verifikasi</span>
                {{-- Badge notif --}}
                @if (($pendingCount ?? 0) > 0)
                    <span
                        class="nav-badge bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none">
                        {{ $pendingCount }}
                    </span>
                @endif
            </a>

            <div class="my-3 mx-5 border-t border-white/10"></div>
    ...
    hover:-translate-y-[1px]">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">bar_chart</span>
                <span class="nav-label text-teal-800 text-sm font-medium group-hover:text-white">Statistik</span>
            </a>
    ...
    hover:-translate-y-[1px]">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">description</span>
                <span class="nav-label text-teal-800 text-sm font-medium group-hover:text-white">Laporan</span>
            </a>
    ...
    hover:-translate-y-[1px] ">
                <span
                    class="nav-icon material-symbols-outlined text-teal-800 text-[20px] group-hover:text-white">settings</span>
                <span class="nav-label text-teal-800 text-sm font-medium group-hover:text-white">Pengaturan</span>
            </a>
    ...
    <div class="flex-1 flex flex-col min-w-0 h-screen">
        ...
        <header class="bg-white border-b border-slate-200 px-6 py-3.5 flex items-center gap-4 flex-shrink-0 z-10">
            ...
            <div class="relative hidden md:block">
                <span
                    class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[16px]">search</span>
                <input type="text" placeholder="Cari..."
                    class="w-52 pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:border-teal-400 focus:bg-white transition-all">
            </div>

            {{-- Notification --}}
            <div class="relative">
                <button
                    class="w-9 h-9 rounded-xl flex items-center justify-center text-slate-500 hover:bg-slate-100 hover:text-teal-800 transition-all">
